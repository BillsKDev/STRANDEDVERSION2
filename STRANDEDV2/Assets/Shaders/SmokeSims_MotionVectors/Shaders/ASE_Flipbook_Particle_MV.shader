	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_4_0_g2 = _RowsColumnsXY.x;
				float temp_output_5_0_g2 = _RowsColumnsXY.y;
				...
				float2 temp_output_16_0 = temp_output_15_0_g2;
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult8_g3 = (float2(totalFrames39_g3 , temp_output_5_0_g3));
				float clampResult42_g3 = clamp( 0.0 , 0.0001 , ( totalFrames39_g3 - 1.0 ) );
				float temp_output_35_0_g3 = frac( ( ( IN.ase_texcoord.xyz.z + clampResult42_g3 ) / totalFrames39_g3 ) );
				float2 appendResult29_g3 = (float2(temp_output_35_0_g3 , ( 1.0 - temp_output_35_0_g3 )));
				float2 temp_output_15_0_g3 = ( ( IN.ase_texcoord.xyz.xy / appendResult7_g3 ) + ( floor( ( appendResult8_g3 * appendResult29_g3 ) ) / appendResult7_g3 ) );
				float2 temp_output_10_0 = temp_output_15_0_g3;
				float2 temp_cast_0 = (1.0).xx;
				float temp_output_36_0 = frac( IN.ase_texcoord.xyz.z );
				float4 tex2DNode12 = tex2D( _MainTex, ( temp_output_10_0 - ( ( ( ( (tex2D( _MotionVector, temp_output_10_0 )).rg * 2.0 ) - temp_cast_0 ) * temp_output_36_0 ) * _Influence ) ) );
				float temp_output_4_0_g2 = _RowsColumnsXY.x;
				float temp_output_5_0_g2 = _RowsColumnsXY.y;
				float2 appendResult7_g2 = (float2(temp_output_4_0_g2 , temp_output_5_0_g2));
				...
				float2 appendResult8_g2 = (float2(totalFrames39_g2 , temp_output_5_0_g2));
				float clampResult42_g2 = clamp( 0.0 , 0.0001 , ( totalFrames39_g2 - 1.0 ) );
				float temp_output_35_0_g2 = frac( ( ( ( IN.ase_texcoord.xyz.z + 1.0 ) + clampResult42_g2 ) / totalFrames39_g2 ) );
				float2 appendResult29_g2 = (float2(temp_output_35_0_g2 , ( 1.0 - temp_output_35_0_g2 )));
				float2 temp_output_15_0_g2 = ( ( IN.ase_texcoord.xyz.xy / appendResult7_g2 ) + ( floor( ( appendResult8_g2 * appendResult29_g2 ) ) / appendResult7_g2 ) );
				float2 temp_output_16_0 = temp_output_15_0_g2;
				float2 temp_cast_1 = (1.0).xx;
				float4 tex2DNode42 = tex2D( _MainTex, ( ( ( ( ( (tex2D( _MotionVector, temp_output_16_0 )).rg * 2.0 ) - temp_cast_1 ) * ( 1.0 - temp_output_36_0 ) ) * _Influence ) + temp_output_16_0 ) );
				float lerpResult49 = lerp( tex2DNode12.a , tex2DNode42.a , temp_output_36_0);
				
				surfaceDescription.Alpha = ( lerpResult49 * IN.ase_color.a );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult8_g3 = (float2(totalFrames39_g3 , temp_output_5_0_g3));
				float clampResult42_g3 = clamp( 0.0 , 0.0001 , ( totalFrames39_g3 - 1.0 ) );
				float temp_output_35_0_g3 = frac( ( ( IN.ase_texcoord1.xyz.z + clampResult42_g3 ) / totalFrames39_g3 ) );
				float2 appendResult29_g3 = (float2(temp_output_35_0_g3 , ( 1.0 - temp_output_35_0_g3 )));
				float2 temp_output_15_0_g3 = ( ( IN.ase_texcoord1.xyz.xy / appendResult7_g3 ) + ( floor( ( appendResult8_g3 * appendResult29_g3 ) ) / appendResult7_g3 ) );
				float2 temp_output_10_0 = temp_output_15_0_g3;
				float2 temp_cast_0 = (1.0).xx;
				float temp_output_36_0 = frac( IN.ase_texcoord1.xyz.z );
				float4 tex2DNode12 = tex2D( _MainTex, ( temp_output_10_0 - ( ( ( ( (tex2D( _MotionVector, temp_output_10_0 )).rg * 2.0 ) - temp_cast_0 ) * temp_output_36_0 ) * _Influence ) ) );
				float temp_output_4_0_g2 = _RowsColumnsXY.x;
				float temp_output_5_0_g2 = _RowsColumnsXY.y;
				float2 appendResult7_g2 = (float2(temp_output_4_0_g2 , temp_output_5_0_g2));
				...
				float2 appendResult8_g2 = (float2(totalFrames39_g2 , temp_output_5_0_g2));
				float clampResult42_g2 = clamp( 0.0 , 0.0001 , ( totalFrames39_g2 - 1.0 ) );
				float temp_output_35_0_g2 = frac( ( ( ( IN.ase_texcoord1.xyz.z + 1.0 ) + clampResult42_g2 ) / totalFrames39_g2 ) );
				float2 appendResult29_g2 = (float2(temp_output_35_0_g2 , ( 1.0 - temp_output_35_0_g2 )));
				float2 temp_output_15_0_g2 = ( ( IN.ase_texcoord1.xyz.xy / appendResult7_g2 ) + ( floor( ( appendResult8_g2 * appendResult29_g2 ) ) / appendResult7_g2 ) );
				float2 temp_output_16_0 = temp_output_15_0_g2;
				float2 temp_cast_1 = (1.0).xx;
				float4 tex2DNode42 = tex2D( _MainTex, ( ( ( ( ( (tex2D( _MotionVector, temp_output_16_0 )).rg * 2.0 ) - temp_cast_1 ) * ( 1.0 - temp_output_36_0 ) ) * _Influence ) + temp_output_16_0 ) );
				float lerpResult49 = lerp( tex2DNode12.a , tex2DNode42.a , temp_output_36_0);
...
/*ASEBEGIN
Version=18935
459;73;955;297;1452.396;522.6368;2.056282;True;False
...
Node;AmplifyShaderEditor.FunctionNode;16;-3013.795,249.1901;Inherit;False;Flipbook;-1;;2;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
Node;AmplifyShaderEditor.FunctionNode;10;-3013.365,-274.5378;Inherit;False;Flipbook;-1;;3;53c2488c220f6564ca6c90721ee16673;2,71,0,68,0;8;51;SAMPLER2D;0.0;False;13;FLOAT2;0,0;False;4;FLOAT;3;False;5;FLOAT;3;False;24;FLOAT;0;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;FLOAT;62
Node;AmplifyShaderEditor.SamplerNode;19;-2679.064,-438.4871;Inherit;True;Property;_MotionVector;MotionVector;2;0;Create;True;0;0;0;False;0;False;-1;547279e36141f6e4dbda7ca1850df41d;547279e36141f6e4dbda7ca1850df41d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;20;-2660.86,248.6124;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;19;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;70;-36.53233,29.2118;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;71;209.4653,-263.7581;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;54;-604.3729,-588.847;Inherit;False;Property;_Fire;Fire;5;1;[HDR];Create;True;0;0;0;False;0;False;76.15007,76.15007,76.15007,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;53;-602.5373,-1021.405;Inherit;False;Property;_Smoke;Smoke;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;594.559,-60.71437;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;PolyToots/Flipbook_MotionVector;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637839900964401851;  Blend;0;0;Two Sided;1;0;Cast Shadows;0;637839902890805339;  Use Shadow Threshold;0;0;Receive Shadows;0;637839902901062143;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=ECE31F747A169B5AE25129B64806B88805E85472